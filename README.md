...
新页面、新功能、UI/UX 调整必须优先遵循 `docs/hkschoolplace_design_system_current.md`。

重点原则：

- 全站产品图标统一使用 Phosphor 风格。
- 登录页、详情页、列表页、账户页不能各自形成独立视觉风格。
- 返回、展开、进入详情、外部链接、关闭等箭头和导航符号必须统一。
- 移动端筛选标签和信息卡片要优先保证清楚、紧凑、好点击。
