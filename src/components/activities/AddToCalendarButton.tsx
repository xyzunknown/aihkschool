...
export function AddToCalendarButton({ activity }: AddToCalendarButtonProps) {
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-button border border-surface-border bg-white px-6 py-3 text-base font-medium text-ink-900 transition-transform "
    >
      <svg
        width="16"
        height="16"
