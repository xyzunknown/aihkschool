    ...
    <article className="overflow-hidden rounded-[22px] border border-cream-200 bg-white shadow-soft transition hover:shadow-card">
      <div className="flex flex-col md:h-[220px] md:flex-row">
        <Link
          ...
          className="relative block h-[180px] overflow-hidden md:h-full md:w-[38%] md:shrink-0"
        ...
        <div className="flex min-w-0 flex-1 flex-col p-5 sm:p-6 md:px-7 md:py-6">
          <div className="min-w-0">
            <div className="flex items-center">
              <span className={`inline-flex h-7 items-center gap-1 rounded-full px-3 text-[13px] font-bold ${accent.bg} ${accent.text}`}>
            ...
            <Link href={`/programmes/${representative.id}`} className="block">
              <h3 className="mt-3 line-clamp-2 text-[22px] font-bold leading-[1.25] text-[#101828] hover:text-brand-700 lg:text-[24px]">
                {group.title}
              </h3>
            </Link>
            <div className="mt-3 flex flex-wrap items-center gap-x-1 text-base leading-[1.4] text-ink-500">
        ...
        <div className="mt-5 flex items-center gap-2 text-base text-[#4b5563] md:mt-[22px]">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row md:mt-auto">
          <button
            type="button"
            onClick={onToggle}
            className="inline-flex h-11 flex-[1.2] items-center justify-center whitespace-nowrap rounded-xl border border-brand-700 bg-brand-700 px-2.5 text-[13px] font-bold text-white transition hover:border-brand-800 hover:bg-brand-800 lg:px-4 lg:text-[14px]"
          ...
          <CourseTrackAllButton
            ...
            className="inline-flex h-11 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl border border-brand-200 bg-white px-2.5 text-[13px] font-bold text-brand-700 transition hover:bg-brand-50 disabled:opacity-50 lg:px-4 lg:text-[14px]"
          />
        </div>
