    ...
    <section className="bg-white">
      <div className="max-w-[1200px] mx-auto px-5 md:px-8 pt-8 pb-2 md:pt-10 md:pb-3">
        <div className="relative overflow-hidden rounded-[30px] min-h-[360px] md:min-h-[420px] lg:min-h-[460px] border border-[#F2E7CC] bg-[#FFF8E9] shadow-[0_20px_44px_rgba(143,111,43,0.08)]">
          <Image
            src="/brand/hero/hero-banner-mobile@2x.jpg"
            alt="家長陪伴孩子閱讀的 Hero 圖"
            fill
            priority
            sizes="100vw"
          ...
          <div className="relative z-10 h-full flex items-start md:items-center px-6 pt-8 pb-7 md:px-10 md:py-10 lg:px-12 lg:py-12">
            <div className="max-w-[640px] rounded-[28px] bg-white/48 backdrop-blur-[2px] border border-white/55 shadow-[0_10px_30px_rgba(143,111,43,0.06)] px-5 py-5 md:px-7 md:py-7 lg:px-8 lg:py-8">
              <h1 className="text-[34px] md:text-5xl lg:text-[52px] font-semibold text-ink-900 leading-[1.18] tracking-tight">
                找到適合 BB 的幼稚園
              </h1>
