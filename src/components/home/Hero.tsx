  ...
  return (
    <section className="bg-surface-page">
      <div className="mx-auto max-w-[1280px] px-5 pb-4 pt-8 md:px-10 md:pb-6 md:pt-10">
        <div className="relative min-h-[360px] overflow-hidden rounded-[28px] border border-surface-border bg-white shadow-card md:min-h-[420px]">
          <Image
          ...
          <div className="relative z-10 flex min-h-[360px] items-end px-5 pb-7 pt-8 md:min-h-[420px] md:items-center md:px-10 md:py-10 lg:px-12">
            <div className="w-full min-w-0 max-w-[610px] flex-none">
              ...
              <h1 className="max-w-[12ch] text-[42px] font-bold leading-[1.1] text-ink-900 md:max-w-[640px] md:text-[56px]">
                {title.split("\n").map((line, index) => (
                  <span key={line || index} className={index > 0 ? "block md:inline" : undefined}>
                    {line}
                  </span>
                ))}
              </h1>
              ...
              <ul className="mt-5 hidden gap-2 text-small text-ink-700 sm:grid-cols-3 md:grid md:max-w-[560px]">
