...
export function FavoriteCard({
  ...
  return (
    <div className="bg-white rounded-card border border-surface-border p-6 shadow-soft hover:shadow-card  transition-all duration-200">
      <div className="flex justify-between items-start">
        <div className="flex-1 cursor-pointer" onClick={onNavigate}>
          ...
          <p className="text-base font-semibold text-ink-900 mt-0.5">{nameTc}</p>
          <p className="text-sm text-ink-500 mt-1">{nameEn}</p>
