      ...
      {vacancy ? (
        <GlassCard className="p-4 md:p-5">
          <div className="mb-3 flex items-start justify-between gap-4">
            ...
            <a href="#report" className="shrink-0 text-small text-ink-500 underline underline-offset-2 hover:text-ink-900">
              回報更新
            </a>
          </div>
            ...
            {(["K1", "K2", "K3"] as const).map((grade) => {
              ...
              return (
                <div key={grade} className="text-center">
                  <h3 className="mb-1.5 text-small font-semibold text-ink-900">{grade}</h3>
