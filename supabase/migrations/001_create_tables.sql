...
CREATE TABLE vacancies (
  ...
  n_vacancy     text NOT NULL DEFAULT 'check_school' CHECK (n_vacancy IN ('has_vacancy','no_vacancy','not_offered','check_school')),
  k1_vacancy    text NOT NULL DEFAULT 'check_school' CHECK (k1_vacancy IN ('has_vacancy','no_vacancy','not_offered','check_school')),
  k2_vacancy    text NOT NULL DEFAULT 'check_school' CHECK (k2_vacancy IN ('has_vacancy','no_vacancy','not_offered','check_school')),
  k3_vacancy    text NOT NULL DEFAULT 'check_school' CHECK (k3_vacancy IN ('has_vacancy','no_vacancy','not_offered','check_school')),
